...
- **Before Stage 2 & 6**: View [`references/prd-template.md`](file:///Users/duboc/.gemini/config/skills/feature-spec/references/prd-template.md) for structural standards.
- **Before Stage 3**: View [`references/user-stories-and-requirements.md`](file:///Users/duboc/.gemini/config/skills/feature-spec/references/user-stories-and-requirements.md) for INVEST rules and Given/When/Then syntax.
- **Before Stage 4**: View [`references/technical-and-edge-cases.md`](file:///Users/duboc/.gemini/config/skills/feature-spec/references/technical-and-edge-cases.md) for security, API contracts, SLAs, and edge case checklists. (If feature involves AI/LLM, also view [`references/ai-and-llm-specs.md`](file:///Users/duboc/.gemini/config/skills/feature-spec/references/ai-and-llm-specs.md)).
- **Before Stage 5**: View [`references/analytics-spec.md`](file:///Users/duboc/.gemini/config/skills/feature-spec/references/analytics-spec.md) for telemetry schemas and PII governance, and [`references/metrics-and-scope.md`](file:///Users/duboc/.gemini/config/skills/feature-spec/references/metrics-and-scope.md) for success metrics and counter-metrics.
...
1. **Full PRD Mode** (Default): Complete end-to-end spec using the template layout in [`references/prd-template.md`](file:///Users/duboc/.gemini/config/skills/feature-spec/references/prd-template.md).
...
5. **Scope Pruning & MVP Rescue Mode**: Analyze an existing spec, challenge P0 vs P1 requirements using the MoSCoW framework ([`references/metrics-and-scope.md`](file:///Users/duboc/.gemini/config/skills/feature-spec/references/metrics-and-scope.md)), and output a phased v1 MVP vs v2 roadmap.
